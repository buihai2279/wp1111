...
class monster_youtube_subscribe_widget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            ...
            <small>ex: <b>https://www.youtube.com/c/buivanhai95</b> or <b>https://www.youtube.com/user/buivanhai95</b> or <b>https://www.youtube.com/buivanhai95</b> or <b>buivanhai95</b>
            <br>
            <a href="https://www.youtube.com/account_advanced">View more</a></small>
        </p>
        <?php if ($id=='' &&isset($instance['account'])&&$instance['account']!='') { ?>
            <p>
                <b style="color: red">Not found ID chanel</b><br>   
                <label for="<?php echo $this->get_field_id( 'id' ); ?>"><?php _e( 'Id chanel youtuebe:' ); ?></label> 
                <input class="widefat" id="<?php echo $this->get_field_id( 'id' ); ?>" name="<?php echo $this->get_field_name( 'id' ); ?>" type="text" value="<?php echo esc_attr( $id ); ?>">
                <small><a href="https://www.youtube.com/account_advanced#account-form">Get ID chanel </a></small>
            </p>
        <?php }else {
            ?>
